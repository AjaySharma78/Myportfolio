...
import programingwithjs from "../assets/programingwithjs.png";
...
const Certificationinfo = [
  {
    ...
    certification_link:
      "https://coursera.org/share/53c45762bcc9d9b7b5be37f0b09680fa",
  ...
  },
  {
    ...
    certification_link:
      "https://coursera.org/share/38233e7c83d60708096cf0aec6486d8a",
    certification_image: frontend,
    completed_date: "Aus 8, 2023",
    certification_desc:
  ...
  },
  {
    ...
    certification_link:
      "https://coursera.org/share/ce5476c2334118d1c69924e22e1aa234",
    certification_image: versioncontrol,
    completed_date: "Aus 14, 2023",
    certification_desc:
...
const Educationinfo = [
  {
    ...
    Joined_date: "11/2019-present",
    Education_desc:
      "Currently pursuing a Bachelor's degree in Computer Engineering from Purbanchal University, Nepal.During my time here, I have learned various programming languages, algorithms, and data structures. I have also worked on several projects and assignments that have helped me gain practical experience in the field of computer science.",
  },
  {
    Education_icon:
      "https://www.shikshadeep.edu.np/images/settings/45fc526bbd66749a46c0873436d8e579.png",
    Education_name: "Shikshadeep College",
    Education_deg: "+2 Science",
    Education_loc: "Birtanagar, Nepal",
    Education_link: "https://www.shikshadeep.edu.np/",
    Joined_date: "2017-2019",
    Education_desc:
      "Completed my +2 Science degree from Shikshadeep College, Nepal. During my time here, I learned about various subjects such as Physics, Chemistry, Mathematics, and Computer Science. I also participated in various extracurricular activities that helped me develop my leadership and communication",
  },
  {
    Education_icon: ".//sicon.png",
    Education_name: "Saptakoshi English School",
    Education_deg: "S.E.E",
    Education_loc: "Birtanagar, Nepal",
    Education_link: "https://www.facebook.com/profile.php?id=100054529086288 ",
    Joined_date: "03/2017  ",
    Education_desc:
      "Completed my School Leaving Certificate (S.E.E) from Saptakoshi English School, Nepal. During my time here, I learned about various subjects such as English, Mathematics, Science, and Social Studies. I also participated in various extracurricular activities that helped me develop my leadership and communication",
  },
];
export {
  Skill_data,
