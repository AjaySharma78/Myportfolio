...
function Home() {
  ...
  return (
    <>
      <div
        id="home"
        className="w-full h-screen bg-hero-pattern bg-cover bg-no-repeat bg-center"
      >
          ...
          >
            ...
            >
              ...
              <div className="flex justify-center items-start flex-col">
                ...
                >
                  ...
                  >
                    Hi, It's me <span className="text-[#915EFF]">Ajay</span>
                  </h1>
                </motion.div>
                <motion.div
                  initial={{
            ...
            <div className="w-full h-1/2 relative md:w-1/2 flex justify-center items-center">
              ...
              <div className="w-full flex justify-center items-center absolute overflow-hidden">
                ...
                >
                  <ProfileImage className="rounded-full w-[170px] lg:w-[300px] " />
                </motion.div>
              </div>
            </div>
          </section>
